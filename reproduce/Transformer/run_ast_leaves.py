...
import numpy as np
import torch
from model_absolute_pos import TransformerClf
...
from read_dataset_ast import CodeDatasetLeaves
...
def train(args, train_dataset, model, vocab):
    ...
    eval_dataset = CodeDatasetLeaves(args, args.eval_data_file, vocab)
...
def test(args, model, vocab):
    ...
    eval_dataset = CodeDatasetLeaves(args, args.test_data_file, vocab)
    eval_sampler = SequentialSampler(eval_dataset)
...
def main():
    ...
    parser.add_argument(
        "--vocab_dir",
        default="/home/qyh/projects/GTE/vocabulary/token_to_index_PC_C++1400.pkl",
        type=str,
    ...
    parser.add_argument("--lang", default="cpp", type=str, help="The language.")
    parser.add_argument(
        "--output_dir",
        default="./output",
        type=str,
    ...
    parser.add_argument("--n_label", default=1400, type=int)
    ...
    run_name = "ast_relative_pos_leaves_C++1400"
    ...
    # Training
    if args.do_train:
        train_dataset = CodeDatasetLeaves(args, args.train_data_file, vocab)

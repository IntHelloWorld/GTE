...
from read_dataset import CodeDataset
...
def main():
    ...
    parser.add_argument(
        "--data_dir",
        default="/home/qyh/Desktop/github/dataset/CodeNet/Project_CodeNet_C++1000_RATIO6-2-2",
        type=str,
    ...
    ## Other parameters
    parser.add_argument(
        "--cache_dir", default="/home/qyh/projects/GTE/reproduce/Pretrained_Models/cache", type=str, help="The cache dir of Pretrained model."
    )
    ...
    parser.add_argument("--n_label", default=1000, type=int)
    ...
    args.device = device
    run_id = datetime.now().strftime("%Y-%m-%d--%H-%M-%S") + "_C++1000"
    ...
    args.run_id = run_id
    logging.basicConfig(
        filename=f"logs/Transformer_{run_id}.log",
    ...
    model = TransformerClf(args.d_model, args.n_head, args.n_layers, args.dropout, tokenizer.vocab_size, args.n_label)
    # model = TransformerClf(tokenizer.vocab_size, args.n_label, args.d_model, args.n_head, args.n_ff, args.n_layers, args.dropout)

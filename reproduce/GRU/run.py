...
def main():
    ...
    parser.add_argument(
        "--train_data_file",
        default="/home/qyh/Desktop/github/dataset/CodeNet/Project_CodeNet_C++1000_RATIO6-2-2/train",
        type=str,
    ...
    parser.add_argument(
        "--eval_data_file",
        default="/home/qyh/Desktop/github/dataset/CodeNet/Project_CodeNet_C++1000_RATIO6-2-2/valid",
        type=str,
        help="An optional input evaluation data file to evaluate the perplexity on (a text file).",
    )
    parser.add_argument(
        "--test_data_file",
        default="/home/qyh/Desktop/github/dataset/CodeNet/Project_CodeNet_C++1000_RATIO6-2-2/test",
        type=str,
        help="An optional input evaluation data file to evaluate the perplexity on (a text file).",
    )
    ...
    parser.add_argument("--learning_rate", default=0.0003, type=float, help="The initial learning rate for Adam.")
    ...
    args.run_id = run_id
    logging.basicConfig(
        filename=f"logs/GRU_{run_id}.log",
    ...
    model = GRUModel(args.d_model, tokenizer, args.n_label)

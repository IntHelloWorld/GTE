...
from PCDataset import PCDataset
from GTE_model_TreeLSTM import GTEProgramClassification
from TreeSampler import BlockSampler
...
class GTESetup:
    ...
    def init_logger(self, log_dir):
        ...
        self.logger = Logger("ProgramClassification_TreeLSTM", str(log_path / f"{self.run_id}_log.txt"))

...
class GTEConv(nn.Module):
    ...
    def __init__(
        ...
        self.horizon_RNN = nn.RNN(hidden_dim, hidden_dim, lstm_n_layers, batch_first=True, bias=bias)
    ...
    def reset_parameters(self):
        ...
        self.horizon_RNN.reset_parameters()
    ...
    def _gru_reducer(self, nodes):
        ...
        if length == 1:
            ...
            # horizontal encode
            output_horizon, h_horizon = self.horizon_RNN(h, current_input)
